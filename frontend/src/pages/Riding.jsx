...
const Riding = () => {
  return (
    <div className="h-screen">
      <Link className="fixed  right-2 top-2h-10 w-10 bg-white flex items-center justify-center
       rounded-full" to="/home">
      ...
      <div className="h-1/2 p-4">
        ...
        <button className="w-full bg-green-600 font-semibold p-2 rounded-lg  mt-5 cursor-pointer text-white">
          Make a Payment
        </button>
      </div>
    </div>
